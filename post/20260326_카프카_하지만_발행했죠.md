...
<div align="center">
    <img src="https://i.namu.wiki/i/XdbAtQfjxXkx3PZ5kO1MQ_78mOjp-n63LtkAYBqnG3SuPGipJ_JIFe65NIRur1vLUr-CNzp-yAho1ZpV0duqa33c8Z8GTW5BDRYIRtaEkx7q_co2P260N12BnEQvm_g8LgTpw_r_0qk3bJZ-M6ooUA.webp" width="200" />
    <p><em>하지만 빨랐죠?</em></p>
</div>
...
<div align="center">
    <img src="img/20260326_kafka/kafka_in_one_single_broker.svg" width="820" />
    <p><em>Kafka 전체 구조(Single Broker) — Producer, Broker, Topic, Partition, Consumer Group</em></p>
</div>

<div align="center">
    <img src="img/20260326_kafka/kafka_in_one_three_broker.svg" width="820" />
    <p><em>Kafka 전체 구조(3 Broker) — Producer, Broker, Topic, Partition, Consumer Group</em></p>
</div>
...
> 지연이 크리티컬한 경우(실시간 채팅 등)에는 Outbox 대신 CDC(Change Data Capture) 기반의 Debezium 같은 도구를 고려할 수 있다. 하지만 대부분의 커머스 시나리오에서 5초 지연은 허용 가능하다.
...
결국 이벤트 기반 아키텍처는 **"복잡도를 제거하는"** 것이 아니라, **"복잡도의 위치를 옮기는"** 것이다. 동기 호출보다 좋은 선택이 아닌 결국 각각의 또 다른 트레이드오프를 나을 수 있는 선택이기에..
